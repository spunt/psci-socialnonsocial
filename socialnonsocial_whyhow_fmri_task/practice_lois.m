function practice_lois(subjectID,inputDevice,w)
%=========================================================================
...
% Paths
basedir = pwd;
stimdir = [basedir filesep 'stimuli/lois_demo'];
...
load([designdir filesep 'demo_design.mat'])
load([designdir filesep 'demo_all_question_data.mat'])
ordered_questions = preblockcues(blockSeeker(:,4));
firstclause = {'Is the person ' 'Is the photo '};
pbc1 = preblockcues;
pbc2 = pbc1; 
...
while noresp
    ...
    if keyIsDown & ismember(keyPressed,one_set)
        noresp=0;
    end;
end;
anchor = secs;
...
%---------------------------------------------------------------
d=clock;
outfile=sprintf('practice_loi_%s_%s_%02.0f-%02.0f.mat',subjectID,date,d(4),d(5));
