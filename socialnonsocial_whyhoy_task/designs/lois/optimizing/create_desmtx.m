...
trials_per_cond=[3 3 3 3 3 3];     % number of trials in each condition (length must much nconds)
...
minISI=6;               % mininimum interstimulus interval (in seconds)
maxISI=9;               % maximum interstimulus interval (in seconds)
meanISI=7;              % desired mean interstimulus interval (in seconds)
restBegin=5;            % amount of rest to add in beginning of scan (in seconds)
restEnd=10;             % amount of rest to add at end of scan (in seconds)
